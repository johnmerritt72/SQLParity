...
public static class CreateTableGenerator
{
    ...
    /// <summary>
    /// SQL Server / SMO auto-generates default-constraint names of the form
    /// <c>DF__&lt;table-prefix&gt;__&lt;column-prefix&gt;_&lt;8-hex&gt;</c>
    /// (e.g. <c>DF__AlcoholSi__Curve_51A50FA1</c>). These names carry no user
    /// intent and differ across environments, so we strip them from canonical
    /// output. User-chosen names (like <c>DF_MyTable_IsActive</c>) are kept.
    /// </summary>
    private static readonly System.Text.RegularExpressions.Regex AutoGenDefaultPattern =
        new System.Text.RegularExpressions.Regex(
            @"^DF__[A-Za-z0-9_]+__[A-Za-z0-9_]+_[A-Fa-f0-9]{8}$",
    ...
    private static bool IsAutoGeneratedConstraintName(string name)
    {
        ...
        return AutoGenDefaultPattern.IsMatch(name);
    }
